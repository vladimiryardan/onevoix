				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="clients/01-simple.cfm" target="_blank">Simple Example</a></li>
							<li><a href="clients/02-advanced.cfm" target="_blank">Advanced Example</a></li>
							<li><a href="clients/03-chat.cfm" target="_blank">Chat App</a></li>
						</ul>
					</li>
					<li><a href="server/broadcast.cfm" id="#broadcast">BROADCAST</a></li>
					<li><a href="server/clients.cfm" id="#clients-link">CLIENTS</a></li>
					<li><a href="server/stats.cfm" id="#live-stats-link">STATS</a></li>
